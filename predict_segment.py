...
#     new_data = pd.read_csv('data/new_transactions.csv', parse_dates=['InvoiceDate'])
    
#     # Initialize segmenter
#     segmenter = CustomerSegmenter()
    
#     # Predict for a customer
#     customer_rfm = segmenter.calculate_rfm(new_data, 'CUST12345')
#     if customer_rfm is not None:
#         segment = segmenter.predict_segment(customer_rfm)
#         print(f"Customer belongs to segment: {segment}")
#     else:
#         print("Customer not found in data")
